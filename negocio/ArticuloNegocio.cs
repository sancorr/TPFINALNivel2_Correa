...
namespace negocio
{
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> listar()
		{
			...
			try
			{
				datos.setConsulta("select A.Id, Codigo, Nombre, A.Descripcion, ImagenUrl, Precio, C.Descripcion Categoria, M.Descripcion Marca, A.IdMarca, A.IdCategoria from ARTICULOS A, CATEGORIAS C, MARCAS M where A.IdCategoria = C.Id AND A.IdMarca = M.Id AND Nombre NOT LIKE 'ELIMINADO%'");
